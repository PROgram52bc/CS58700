...
def train(
    ...
    *,
    ...
    for batch_indices in (
        ...
        # print("loss_pos: {}".format(loss_pos.item()))
        loss_neg = -torch.log(1 - edge_probs_neg + 1e-15).mean()
        # print("loss_neg: {}".format(loss_neg.item()))
...
def main(*ARGS) -> None:
    ...
    # print("edge_indices: {}".format(edge_indices))
    # print("edge_weights: {}".format(edge_weights))
    # print("edge_pos_train: {}".format(edge_pos_train))
    # print("edge_pos_valid: {}".format(edge_pos_valid))
    ...
    # 256 hidden features, 4267 input nodes, 2 layers
