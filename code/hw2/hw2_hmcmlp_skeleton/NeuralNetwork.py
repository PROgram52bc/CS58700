...
class NeuralNetwork(nn.Module):
    ...
    def predict(self, X):
        ...
        # take maximum along the second dimension max(..., 1)
        # max returns a tuple of (values, indices)
    ...
    def energy(self, X, y, y_1hot):
        ...
        Args:
            X: (n_examples, n_features)
            y: (n_examples). we used this
            y_1hot: didn't use this
